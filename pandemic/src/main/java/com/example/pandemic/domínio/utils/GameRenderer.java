...
public class GameRenderer {
    ...
    public static String renderGameState(Jogo jogo) {
        ...
        sb.append(CityRenderer.renderCitiesGrid(jogo.getTabuleiro().getCidades(), jogo.getJogadores()));
    ...
    private static String renderGameStatus(Jogo jogo) {
        ...
        sb.append("   ├─ Turno: ").append(jogo.getTurnoAtual()).append("\n");
        ...
        sb.append("   └─ Ações restantes: ").append(jogo.getAcoesRestantes()).append("\n");
        return sb.toString();
    }
